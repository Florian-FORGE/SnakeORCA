...
Usage:
    python mutate_and_rdm.py --abs_to_rel_log_path <path_to_log_file> \
                             ...
                             [--binsize_permut <binsize_for_permutations>] \
                             [--rdm_seq <True|False>] \
...
def mutate_and_rdm_mutations(abs_to_rel_log_path: str, mut_path: str, muttype: str = "shuffle", 
                             sequence:str = ".", nb_random: int = 0, binsize_permut=None, 
                             rdm_pos: bool = True, excluded_domains: str = None, 
                             included_into: str = None, distrib: str = None, 
                             binsize_distrib: int = 128_000, 
    ...
    for i in range(nb_random):
        ...
        if rdm_pos:
            random_mutations = mm.generate_random_pos_mutations(mutations=mutations, genome=relative_fasta, rdm_seed=rdm_seed, 
                                                                ...
                                                                included_into=included_into, distrib=distrib, 
                                                                binsize_distrib=binsize_distrib, region=region)
        else :
